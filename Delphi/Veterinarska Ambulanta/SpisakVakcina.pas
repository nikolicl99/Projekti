...
var
  frmspisakVakcina: TfrmspisakVakcina;

implementation

{$R *.fmx}
uses main, spisakzivotinja;

procedure TfrmspisakVakcina.FormCreate(Sender: TObject);
var
  Query: TFDQuery;
  Row: Integer;
begin
  ...
  try
    ...
    Query.SQL.Text :=
      ...
      'WHERE Klijent_Vakcinacija.Klijent = :KlijentID';
    Query.ParamByName('KlijentID').AsInteger := frmspisakzivotinja.SelectedID;
    Query.Open;
...
procedure TfrmspisakVakcina.NazadClick(Sender: TObject);
begin
